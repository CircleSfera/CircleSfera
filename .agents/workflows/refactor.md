...
Improve code structure with no observable behaviour change. Invoke with `/refactor`.
...
3. Consult these specialists in order, adopting the checks and hard rules of each for the part of
   the work it owns: refactoring, staff-architect, code-reviewer, qa. Role definitions:
   - @/.ai/agents/README.md
...
If you had to change a test assertion, you changed behaviour. Stop and say so.
