...
Restructure a screen or improve a UI surface without changing CircleSfera's visual identity. Invoke
with `/ui-redesign`.
...
3. Consult these specialists in order, adopting the checks and hard rules of each for the part of
   the work it owns: ux-researcher, product, design-system, frontend, accessibility. Role
   definitions:
   - @/.ai/agents/README.md
...
6. Close with:
   - @/.ai/checklists/ui.md
   - @/.ai/checklists/accessibility.md
...
Benchmarking other products means extracting the principle, never replicating layout, iconography,
colour, typography or components.
