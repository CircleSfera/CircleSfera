...
| [`architecture.md`](./architecture.md) | System structure, boundaries, ADRs — then implement when asked |
...
| [`schema-change.md`](./schema-change.md) | Touching `schema.prisma` (after confirmation) |
...
| [`audit.md`](./audit.md) | Architecture audit, transversal drift, multi-domain review |
