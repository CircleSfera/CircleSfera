...
const POST_DATA = [
  {
    ...
    caption:
      'Acabo de terminar esta nueva pieza. He intentado jugar con tonos cálidos para transmitir tranquilidad. ¿Qué os parece? 🎨✨',
    image:
  ...
  },
  {
    authorUsername: 'IsabellaArts',
    caption:
      'Mi espacio de trabajo hoy. La inspiración llega cuando el entorno está en armonía. 🌿',
    image:
      'https://images.unsplash.com/photo-1501004318641-b39e6451bec6?auto=format&fit=crop&q=80&w=1000',
  },
  {
    authorUsername: 'MarcosLens',
    caption:
      'Luces de neón en Tokyo. La ciudad que nunca duerme siempre ofrece la mejor iluminación para mis fotos nocturnas. 📸🌃',
    image:
  ...
  },
  {
    authorUsername: 'MarcosLens',
    caption:
      'Retrato espontáneo en las calles de Madrid. A veces las mejores fotos no están planeadas.',
    image:
      'https://images.unsplash.com/photo-1511895426328-dc8714191300?auto=format&fit=crop&q=80&w=1000',
  },
  {
    authorUsername: 'ElenaTech',
    caption:
      'Nuevo setup para programar en casa. Monitores ultra-panorámicos y buen café, no necesito nada más. 💻☕️',
    image:
  ...
  },
  {
    ...
    caption:
      'Despertar con estas vistas en los Alpes Suizos no tiene precio. El mundo es demasiado grande para quedarse en un solo lugar. 🏔️✈️',
    image:
  ...
  },
  {
    authorUsername: 'AlexNomad',
    caption:
      'Perdido por las calles de Kyoto. La arquitectura tradicional japonesa es simplemente fascinante. 🇯🇵',
    image:
  ...
  },
  {
    authorUsername: 'IsabellaArts',
    caption:
      'Bocetos rápidos del fin de semana. A veces hay que soltar la mano y dejar que las ideas fluyan. ✏️',
    image:
