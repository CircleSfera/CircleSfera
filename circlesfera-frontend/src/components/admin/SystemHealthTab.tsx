    ...
    return (
      <div className="bg-red-500/10 border border-red-500/20 rounded-2xl p-8 text-center flex flex-col items-center">
        ...
        <button
          type="button"
          onClick={() => refetch()}
          className="px-6 py-3 bg-red-500/20 text-red-400 font-black uppercase tracking-widest text-xs rounded-xl hover:bg-red-500/30 transition-colors flex items-center gap-2"
        >
          <RefreshCw size={16} />
          Reintentar Conexión
        </button>
    ...
    <div className="space-y-8 pb-20">
      ...
      <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-4">
        ...
        <div className="flex items-center gap-4">
          ...
          <button
            ...
            className="w-10 h-10 rounded-xl bg-white/5 border border-white/10 flex items-center justify-center text-white hover:bg-white/10 transition-colors disabled:opacity-50"
          >
            <RefreshCw
              size={16}
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <motion.div
          ...
          className={`p-6 rounded-2xl border ${dbBorder} ${dbBg} relative overflow-hidden`}
        >
        ...
        <motion.div
          ...
          className={`p-6 rounded-2xl border ${isAiQueueHealthy ? 'border-indigo-500/20 bg-indigo-500/10' : 'border-amber-500/20 bg-amber-500/10'} relative overflow-hidden`}
        >
          <div className="flex items-center justify-between mb-8">
            <div className="flex items-center gap-3">
              <div
        ...
        <motion.div
          ...
          className={`p-6 rounded-2xl border ${isAnalyticsQueueHealthy ? 'border-brand-primary/20 bg-brand-primary/10' : 'border-amber-500/20 bg-amber-500/10'} relative overflow-hidden`}
        >
          <div className="flex items-center justify-between mb-8">
            <div className="flex items-center gap-3">
              <div
        ...
        <motion.div
          ...
          className="lg:col-span-3 p-6 rounded-2xl glass-panel border border-white/5 relative overflow-hidden flex flex-col md:flex-row items-center gap-8"
        >
          <div className="flex items-center gap-4 md:w-1/3">
            <div className="w-16 h-16 rounded-2xl bg-white/5 border border-white/10 flex items-center justify-center text-white shadow-xl">
              <Webhook size={32} />
            </div>
            <div>
          ...
          <div className="flex-1 grid grid-cols-2 md:grid-cols-3 gap-6 w-full">
            ...
            <div className="bg-black/30 rounded-xl p-4 border border-red-500/20 relative overflow-hidden">
              ...
              <p className="text-[10px] font-bold text-red-500 uppercase tracking-widest mb-2 flex items-center gap-2 relative z-10">
