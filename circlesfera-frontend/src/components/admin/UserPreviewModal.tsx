 ...
 * Compact ops dossier — not a centered modal.
 */
        ...
        <div className="space-y-6 pb-4">
          ...
          <section className="space-y-3">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-x-4 gap-y-3">
              <SystemField
                label={t('admin.user_preview.verification_level_label')}
              >
              ...
              {user.stripeIdentitySessionId && (
                <SystemField
                  label={t('admin.user_preview.stripe_session_label')}
                >
                  <span
