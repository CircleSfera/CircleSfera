      ...
      <div className="w-full space-y-1.5">
        ...
        <div className="relative flex items-center">
          ...
          <input
            id={inputId}
            ref={ref}
            className={`flex h-10 w-full rounded-xl border bg-white/5 backdrop-blur-md px-4 py-2 text-sm text-white file:border-0 file:bg-transparent file:text-sm file:font-medium placeholder:text-gray-400 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-brand-primary/40 focus-visible:border-brand-primary/50 disabled:cursor-not-allowed disabled:opacity-50 transition-all shadow-inner ${
              error
