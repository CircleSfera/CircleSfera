      ...
      <div className={`flex items-center justify-between gap-4 ${className}`}>
        ...
        >
          <input
            ...
            {...props}
          />
          <div className="w-11 h-6 bg-white/10 backdrop-blur-md peer-focus:outline-none peer-focus:ring-2 peer-focus:ring-brand-primary/50 rounded-full peer peer-checked:after:translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-0.5 after:left-0.5 after:bg-white after:border-gray-300 after:border after:rounded-full after:h-5 after:w-5 after:transition-all peer-checked:bg-linear-to-r peer-checked:from-brand-primary peer-checked:to-brand-primary/80 border border-white/10 shadow-inner"></div>
        </label>
      </div>
    );
  },
