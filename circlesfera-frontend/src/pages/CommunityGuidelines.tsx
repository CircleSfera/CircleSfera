        ...
        <nav className="fixed top-0 left-0 right-0 z-50 glass-panel border-b border-white/5 px-5 py-2 flex justify-between items-center backdrop-blur-xl bg-transparent">
          ...
          <div className="flex items-center gap-5">
            ...
            <Link
              ...
              className="px-5 h-10 flex items-center justify-center text-xs font-bold bg-white text-black rounded-full hover:bg-white/90 transition-all hover:scale-105 active:scale-95 shadow-[0_0_20px_rgba(255,255,255,0.15)]"
            >
              {t('legal.nav.sign_up')}
            </Link>
          </div>
        ...
        <div className="flex flex-col lg:flex-row gap-12">
          ...
          <aside className="hidden lg:block w-64 shrink-0">
            <div className="sticky top-28 space-y-4">
              <div>
                <span className="text-brand-primary font-black text-xs tracking-wide uppercase mb-3 block">
