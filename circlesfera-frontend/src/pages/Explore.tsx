...
export default function Explore() {
  ...
  return (
    <div className="pb-20 min-h-screen w-full md:max-w-6xl md:mx-auto">
      <SEO
        title={t('explore.page_title')}
        description={t('explore.page_desc')}
      />

      {/* IG Style Top Search Bar */}
      <div className="sticky top-0 z-50 bg-[#000000] px-4 py-2 border-b border-white/10 md:pt-10 md:pb-6 md:bg-transparent md:border-none md:static">
        <div className="flex items-center gap-3">
          <div className="relative flex-1 group">
            ...
            <input
              ...
              className="w-full pl-10 pr-10 py-2 bg-[#262626] rounded-[10px] text-white placeholder-zinc-500 focus:outline-none focus:bg-[#363636] transition-colors text-[15px]"
            />
            {query && (
              <button
                type="button"
                onClick={() => setQuery('')}
                className="absolute right-3 top-1/2 -translate-y-1/2 text-zinc-400 hover:text-white bg-zinc-600 rounded-full p-0.5"
              >
                        ...
                        {searchResults.users.map((user: SearchUserResult) => (
                          ...
                          >
                            <UserAvatar
                              ...
                              size="md"
                              isVerified={user.verificationLevel !== 'BASIC'}
                            />
